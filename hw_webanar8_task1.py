...
def treatment_sum(our_tuple: tuple):
    """Функция проверяет количество элементов кортежа, если их ровно два выводит сумму, в противном случае
    выводит исключение
    :param our_tuple: входной кортеж
    :return: сумма двух элементов кортежа либо текст исключения"""
