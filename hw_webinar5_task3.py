...
def everything_for_your_cat(cats_data):
    ...
    for owner in cats_data:
        if f'{owner[2]} {owner[3]}:' not in finnish_dict:
            finnish_dict[f'{owner[2]} {owner[3]}:'] = f'{owner[0]}, {owner[1]}'
        else:
            finnish_dict[f'{owner[2]} {owner[3]}:'] = finnish_dict.get(f'{owner[2]} {owner[3]}:') \
                                                      + f'; {owner[0]}, {owner[1]}'
    for people, pets in finnish_dict.items():
        our_str += f'{people} {pets}\n'
    return our_str
